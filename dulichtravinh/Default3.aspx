<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="Default3.aspx.cs" Inherits="dulichtravinh.WebForm8" %>
            ...
            <div class="container">
                ...
                <div class="container__explore">
                    ...
                    <%--<div class="travinh__background"> 
                        <img class="travinh__background--img" src="#" alt=""> 
                    </div> --%>
                </div> 
            </div> 
        </section> 
                                ...
                                <div class="col-6"> 
                                    <div class="row"> 
                                        ...
                                        <div class="col-6"> 
                                            <div class="row"> 
                                                <div class="col-12"> 
                                                    <img class="w-100 rounded" src="https://images.unsplash.com/photo-1648996024018-5c97f307fa6a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1068&q=80" alt=""> 
                                                </div> 
                                            </div> 
                                            <div class="row mt-4"> 
                                                <div class="col-12"> 
